        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReturnBookingId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Bookings_ReturnBookingId",
                        column: x => x.ReturnBookingId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoardingPass = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ReturnBookingId",
                table: "Bookings",
                column: "ReturnBookingId",
                unique: true,
                filter: "[ReturnBookingId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_DepartureTime_RouteId",
                table: "Flights",
